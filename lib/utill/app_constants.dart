...
class AppConstants {
  static const String APP_NAME = 'SupplyCosm';

  static const String BASE_URL = 'http://supplycosm.com';
  ...
  static List<LanguageModel> languages = [
    ...
    LanguageModel(imageUrl: Images.arabic, languageName: 'Arabic', countryCode: 'MR', languageCode: 'ar'),
